...
section: "Settings-to-Restore Purchase"
order: 1
...
* **requestItemListOfNotConsumedWithCompletion:**를 호출하여 재처리를 동작시켜 미지급된 아이템이 있으면 [Consume Flow](./ios-purchase-Settings-to-Restore-Purchase.md#consume-flow) 를 진행하세요.
