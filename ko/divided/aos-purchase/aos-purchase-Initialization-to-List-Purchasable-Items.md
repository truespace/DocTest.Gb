...
section: "Initialization-to-List Purchasable Items"
order: 1
...
아이템 구매는 크게 **결제 Flow** 와 **[Consume Flow](./aos-purchase-Initialization-to-List-Purchasable-Items.md#consume-flow)**, **[재처리 Flow](./aos-purchase-Initialization-to-List-Purchasable-Items.md#retry-transaction-flow)** 로 나누어 볼 수 있습니다.
...
* **requestItemListOfNotConsumed**를 호출하여 재처리를 동작시켜 미지급된 아이템이 있으면 [Consume Flow](./aos-purchase-Initialization-to-List-Purchasable-Items.md#consume-flow) 를 진행하세요.
