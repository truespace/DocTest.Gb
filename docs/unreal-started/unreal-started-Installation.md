...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Unreal Editor의 Gamebase - Android 플러그인 설정 화면
    구성: Unreal Editor Project Settings 창에서 플러그인 카테고리의 Gamebase - Android 설정 화면. 좌측에 플랫폼/플러그인 카테고리 트리, 우측에 Authentication(IdP 활성화 옵션), Push(FCM 설정), Purchase(스토어 선택) 섹션이 표시됨
    Keyword: Unreal, Screenshot, Android Settings, Project Settings
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Unreal Editor의 Gamebase - iOS 플러그인 설정 화면
    구성: Unreal Editor Project Settings 창에서 플러그인 카테고리의 Gamebase - iOS 설정 화면. Path(Xcode 경로), Info.plist(자동 업데이트, Contact 권한, Tracking 설정), Authentication(IdP별 활성화 및 Facebook/Google/Weibo 추가 설정), Purchase(스토어 선택), Push(푸시 서비스 설정) 섹션이 표시됨
    Keyword: Unreal, Screenshot, iOS Settings, Project Settings
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Unreal Editor의 Gamebase - Windows 플러그인 설정 화면
    구성: Unreal Editor Project Settings 창에서 플러그인 카테고리의 Gamebase - Windows 설정 화면. Authentication(IdP 활성화 옵션), Purchase(스토어 선택 및 Epic Games Store EOS 서비스 정보 입력) 섹션이 표시됨
    Keyword: Unreal, Screenshot, Windows Settings, Project Settings
-->
