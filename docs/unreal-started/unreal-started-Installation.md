...
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: SDK 가이드 화면 (Android Settings)
    구성: SDK 설정/사용 가이드 관련 스크린샷
    Keyword: Unreal, SDK, Screenshot, Android Settings
-->
...
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: SDK 가이드 화면 (Project Settings)
    구성: SDK 설정/사용 가이드 관련 스크린샷
    Keyword: Unreal, SDK, Screenshot, Project Settings
-->
...
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: SDK 가이드 화면 (Windows Settings)
    구성: SDK 설정/사용 가이드 관련 스크린샷
    Keyword: Unreal, SDK, Screenshot, Windows Settings
-->
