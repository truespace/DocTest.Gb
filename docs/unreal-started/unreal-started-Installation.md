...
keyword: "Unreal, XCode, Login, Purchase, Push, Notification, WebView, Contact, IdP, setttings"
...
1. Gamebase Unreal SDK를 다운로드한 뒤 프로젝트 경로에 **Plugins** 폴더를 만들고, 다운로드한 SDK 내부 **NHNCloud** 폴더를 추가합니다.
    * [Download Gamebase Unreal SDK](https://docs.nhncloud.com/Download/#game-gamebase)
