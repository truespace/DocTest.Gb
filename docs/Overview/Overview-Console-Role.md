...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: NHN Cloud 콘솔 회원 등록 및 권한 부여 화면
    구성: NHN Cloud 회원 등록 다이얼로그로, Gamebase 서비스를 검색하여 ADMIN, ANALYTICS VIEWER - ALL, ANALYTICS VIEWER - EXCLUDING SALES, ANALYTICS VIEWER - ONLY REAL-TIME, APP ADMIN, APP VIEWER 등의 권한 목록이 표시된 화면
    Keyword: Screenshot, Console, Manage Role, 회원 등록
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: NHN Cloud 콘솔 프로젝트 권한 그룹 관리 화면
    구성: 권한 그룹 관리 테이블로, 역할 그룹 추가/삭제 버튼, 역할 그룹 이름(Gamebase 운영자), 설명(운영자 권한), 유형(프로젝트 정의 그룹), 멤버 수, 역할 수(25개), 추가일 등의 컬럼이 표시된 목록 화면
    Keyword: Screenshot, Console, Manage Role, 권한 그룹
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: NHN Cloud 콘솔 조직 프로젝트 공통 역할 그룹 설정 화면
    구성: 조직 설정의 프로젝트 공통 역할 그룹 관리 화면으로, 역할 그룹 목록(Gamebase 운영자 등)과 해당 그룹에 포함된 Gamebase ADMIN, ANALYTICS VIEWER - ALL 등 세부 권한 항목이 표시된 화면
    Keyword: Screenshot, Console, Manage Role, 조직 권한 그룹
-->
