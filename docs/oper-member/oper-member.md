...
keyword: Console, Login, Mapping, Withdraw, Purchase, Consume, Android, iOS
---
...
### Detail Information
![member_01](./image/member_01_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Detail Information 화면 #01
    구성: Gamebase 회원 관리 콘솔의 Detail Information 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Detail Information
-->
...
![member_02](./image/member_02_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Detail Information 화면 #02
    구성: Gamebase 회원 관리 콘솔의 Detail Information 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Detail Information
-->
...
#### 계정 상태 변경
![member_03](./image/member_03_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 계정 상태 변경 화면 #03
    구성: Gamebase 회원 관리 콘솔의 계정 상태 변경 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, 계정 상태 변경
-->
...
##### 제공 예시
![member_04](./image/member_04_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 매핑 추가 화면 #04
    구성: Gamebase 회원 관리 콘솔의 매핑 추가 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, 매핑 추가
-->
![member_05](./image/member_05_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 매핑 추가 화면 #05
    구성: Gamebase 회원 관리 콘솔의 매핑 추가 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, 매핑 추가
-->
...
![member_06](./image/member_06_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 매핑 해제 화면 #06
    구성: Gamebase 회원 관리 콘솔의 매핑 해제 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, 매핑 해제
-->

* **해제** 버튼을 클릭하면 아래와 같이 최종 확인 창과 함께 IdP 정보를 확인합니다. **확인** 버튼을 클릭하면 매핑이 해제됩니다.

![member_07](./image/member_07_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 매핑 해제 화면 #07
    구성: Gamebase 회원 관리 콘솔의 매핑 해제 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, 매핑 해제
-->

### Login History
![member_08](./image/member_08_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Login History 화면 #08
    구성: Gamebase 회원 관리 콘솔의 Login History 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Login History
-->
...
### Mapping History
![member_09](./image/member_09_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Mapping History 화면 #09
    구성: Gamebase 회원 관리 콘솔의 Mapping History 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Mapping History
-->
...
![member_10](./image/member_10_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Mapping History 화면 #10
    구성: Gamebase 회원 관리 콘솔의 Mapping History 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Mapping History
-->

### Purchase History
![member_11](./image/member_11_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Purchase History 화면 #11
    구성: Gamebase 회원 관리 콘솔의 Purchase History 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Purchase History
-->
...
### Ban History
![member_12](./image/member_12_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Ban History 화면 #12
    구성: Gamebase 회원 관리 콘솔의 Ban History 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Ban History
-->
...
### Playtime
![member_13](./image/member_13_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Playtime 화면 #13
    구성: Gamebase 회원 관리 콘솔의 Playtime 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Playtime
-->
조회한 사용자가 게임을 플레이한 시간을 일자별로 조회합니다.
원하는 날짜를 입력하여 조회할 수 있으며 조회가 가능한 최대 날짜는 1개월(30일)입니다.

### Coupon using history
![member_14](./image/member_14_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Coupon using history 화면 #14
    구성: Gamebase 회원 관리 콘솔의 Coupon using history 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Coupon using history
-->

### Inquiry history
![member_15](./image/member_15_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Inquiry history 화면 #15
    구성: Gamebase 회원 관리 콘솔의 Inquiry history 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Inquiry history
-->

### Withdraw History
![member_16](./image/member_16_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Withdraw History 화면 #16
    구성: Gamebase 회원 관리 콘솔의 Withdraw History 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Withdraw History
-->
...
![member_17](./image/member_17_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Transfer account 화면 #17
    구성: Gamebase 회원 관리 콘솔의 Transfer account 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Transfer account
-->
**단말기 이전 발급 키**
...
![member_18](./image/member_18_kr_240103.png)
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase 회원 관리 콘솔 Reissuance Transfer account 화면 #18
    구성: Gamebase 회원 관리 콘솔의 Reissuance Transfer account 기능 설정/조회 화면 스크린샷
    Keyword: 회원, Console, Screenshot, Reissuance Transfer account
-->
