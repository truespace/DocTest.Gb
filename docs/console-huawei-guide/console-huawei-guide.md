...
keyword: "Console, IAP, Huawei AppGallery 콘솔 가이드"
---
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: 화웨이 개발자 콘솔에서 AppGallery Connect 선택
    구성: '화웨이 개발자 콘솔에서 AppGallery Connect 선택' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: Console, Huawei
-->
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: AppGallery 콘솔 메인 화면
    구성: 'AppGallery 콘솔 메인 화면' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: App, Console, Huawei, Store
-->
   ![MyApps 메뉴에서 신규 앱 등록](http://static.toastoven.net/prod_gamebase/StoreConsoleGuide/huawei_console_app_01_eng.png)
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: MyApps 메뉴에서 신규 앱 등록
    구성: 'MyApps 메뉴에서 신규 앱 등록' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: App, Console, Huawei, Store
-->
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: 화웨이 신규 앱 등록 화면
    구성: '화웨이 신규 앱 등록 화면' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: App, Console, Huawei, Setting, Store
-->
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: NHN Cloud Gamebase Store Settings
    구성: 'NHN Cloud Gamebase Store Settings' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: App, Console, Huawei, Setting, Store
-->
### Store App ID
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: AppGallery Connect 프로젝트 기본 정보 화면
    구성: 'AppGallery Connect 프로젝트 기본 정보 화면' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: App, Console, Huawei, Setting, Store
-->
...
<!-- LLM_Image_DESC_20260407
    ...
    내용: AppGallery Connect 프로젝트 기본 정보 화면
    구성: 'AppGallery Connect 프로젝트 기본 정보 화면' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: App, Console, Huawei, IAP, Setting
-->
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: AppGallery Connect IAP 화면
    구성: 'AppGallery Connect IAP 화면' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: App, Console, Huawei, IAP, Setting
-->