...
keyword: "Android SDK 사용 가이드, 초기화, onActivityResult, Initialization Flow, Configuration Settings"
---
...
> [Game > Gamebase > Android SDK 사용 가이드 > ETC > Additional Features > Gamebase Event Handler > Observer](../../aos-etc.md#observer)
