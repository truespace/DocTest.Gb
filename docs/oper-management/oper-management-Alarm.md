...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Gamebase 관리 콘솔 Alarm 화면 #02
    구성: Gamebase 관리 콘솔의 Alarm 기능 설정/조회 화면 스크린샷
    Keyword: 관리, Console, Screenshot, Alarm
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Gamebase 관리 콘솔 Alarm Log 화면 #03
    구성: Gamebase 관리 콘솔의 Alarm Log 기능 설정/조회 화면 스크린샷
    Keyword: 관리, Console, Screenshot, Alarm Log
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Gamebase 관리 콘솔 (1) 목록 조회 화면 #04
    구성: Gamebase 관리 콘솔의 (1) 목록 조회 기능 설정/조회 화면 스크린샷
    Keyword: 관리, Console, Screenshot, (1) 목록 조회
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Gamebase 관리 콘솔 (2) 등록 화면 #05
    구성: Gamebase 관리 콘솔의 (2) 등록 기능 설정/조회 화면 스크린샷
    Keyword: 관리, Console, Screenshot, (2) 등록
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Gamebase 관리 콘솔 (2) 상세조회/수정/삭제 화면 #06
    구성: Gamebase 관리 콘솔의 (2) 상세조회/수정/삭제 기능 설정/조회 화면 스크린샷
    Keyword: 관리, Console, Screenshot, (2) 상세조회/수정/삭제
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Gamebase 관리 콘솔 Recipient List 화면 #07
    구성: Gamebase 관리 콘솔의 Recipient List 기능 설정/조회 화면 스크린샷
    Keyword: 관리, Console, Screenshot, Recipient List
-->
