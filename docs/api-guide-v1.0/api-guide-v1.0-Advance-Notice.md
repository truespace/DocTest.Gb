...
<!-- LLM_Image_DESC_20260406
    ...
    구성: NHN Cloud 콘솔의 Gamebase 모니터링 화면 배경에 'URL & Appkey - Gamebase' 팝업이 표시됨. URL 필드에 'https://api-gamebase.cloud.toast.com'이 입력되어 있으며 빨간색 테두리로 강조됨. Appkey, SecretKey 필드도 함께 표시됨. 배경에 CCU(2,396)와 DAU(5,465) 실시간 지표가 보임
    Keyword: Gamebase, 콘솔, 서버주소, URL, Appkey, 모니터링
-->
