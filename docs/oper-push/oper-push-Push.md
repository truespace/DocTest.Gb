...
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase Push 콘솔 Push 화면 #01
    구성: Gamebase Push 콘솔의 Push 기능 설정/조회 화면 스크린샷
    Keyword: Push, Console, Screenshot, Push
-->
...
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase Push 콘솔 푸시 상세 정보 화면 #02
    구성: 발송 이력에서 선택한 푸시의 상세 정보 화면으로, 발송 타입/대상/이벤트 키 등록/대상 국가/메시지 타입/메시지 내용 등 전송된 푸시의 등록 정보와 우측에 Android/iOS 단말기 미리보기가 함께 표시되는 스크린샷
    Keyword: Push, Console, Screenshot, 푸시 상세 정보, Send History
-->
...
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase Push 콘솔 푸시 등록 화면 #03
    구성: 새 푸시 등록 폼으로 (1)발송 타입, (2)발송 대상, (3)이벤트 키, (4)대상 국가, (5)메시지 타입, (6)메시지 내용, (7)메시지 글자색 등 번호가 매겨진 입력 항목들과 우측에 Android/iOS 단말기 미리보기가 함께 표시되는 스크린샷
    Keyword: Push, Console, Screenshot, 푸시 등록, Register Push
-->
...
<!-- LLM_Image_DESC_20260408_191856
    유형: Screenshot
    내용: Gamebase Push 콘솔 이벤트 키 선택 팝업 #04
    구성: 푸시 발송 시 통계용 이벤트 키를 선택하는 팝업 화면으로, 등록ID/이벤트 키/설명/수집 기간/등록일시/상태(수집중/종료) 컬럼의 목록과 선택 버튼, 페이지네이션, 닫기 버튼으로 구성
    Keyword: Push, Console, Screenshot, 이벤트 키, Event Key
-->
