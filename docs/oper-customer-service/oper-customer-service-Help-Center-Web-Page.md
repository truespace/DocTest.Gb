...
<!-- LLM_Image_DESC_20260406
    유형: UI
    내용: Gamebase 고객센터 - Help Center 메인 화면 (모바일 웹뷰)
    구성: 상단에 'Help Center' 헤더와 닫기(X) 버튼이 있음. 1:1 문의, 내 문의의 내역 탭과 언어(KOR) 선택이 있음. 검색어 입력란, 자주 하는 질문 BEST 카테고리 버튼(패스워드, 인증, 결제, 콘텐츠, 로그인, 계정), 공지 사항 섹션이 배치됨
    Keyword: Help Center, 모바일, 1:1 문의, 자주하는 질문, 공지사항
-->
...
<!-- LLM_Image_DESC_20260406
    유형: UI
    내용: Gamebase 고객센터 - 1:1 문의 등록 화면 (모바일 웹뷰)
    구성: 상단에 'Help Center' 헤더와 '1:1 문의' 탭이 있음. 문의 유형 선택, 답변 이메일 입력, 이름(닉네임) 입력, 제목 입력, 문의 내용 입력, 첨부 파일 영역이 세로로 배치됨. 하단에 개인 정보 수집 동의 체크박스와 등록 버튼이 있음
    Keyword: 1:1 문의, 문의 등록, 모바일, 문의 유형, 첨부 파일
-->
...
<!-- LLM_Image_DESC_20260406
    유형: UI
    내용: Gamebase 고객센터 - 내 문의 내역 화면 (로그인 상태, 모바일 웹뷰)
    구성: 상단에 'Help Center' 헤더와 '내 문의의 내역' 탭이 선택되어 있음. 문의 상태(접수), 문의 유형, 제목, 질문 내용, 날짜가 표시되며, 하단에 추가 문의/목록 버튼이 배치됨
    Keyword: 내 문의 내역, 로그인, 문의 상태, 모바일, 접수
-->
...
<!-- LLM_Image_DESC_20260406
    유형: UI
    내용: Gamebase 고객센터 - Help Center 메인 화면 (비로그인 상태, 모바일 웹뷰)
    구성: 상단에 'Help Center' 헤더와 닫기(X) 버튼이 있음. 1:1 문의 탭만 표시되고 내 문의 내역 탭은 없음. 검색어 입력란, 자주 하는 질문 BEST 카테고리 버튼, 공지 사항 섹션이 배치됨
    Keyword: Help Center, 비로그인, 모바일, 1:1 문의, 자주하는 질문
-->
...
<!-- LLM_Image_DESC_20260406
    유형: UI
    내용: Gamebase 고객센터 - FAQ 화면 (모바일 웹뷰, 3가지 상태)
    구성: 3개의 모바일 화면이 나란히 배치됨. 왼쪽은 전체 FAQ 목록(카테고리 버튼과 질문 목록), 가운데는 특정 카테고리(인증) 선택 시 해당 FAQ 목록, 오른쪽은 검색 결과로 특정 질문과 답변이 펼쳐진 상태를 보여줌
    Keyword: FAQ, 자주하는 질문, 카테고리, 검색, 모바일 웹뷰
-->
...
<!-- LLM_Image_DESC_20260406
    유형: UI
    내용: Gamebase 고객센터 - 공지사항 화면 (모바일 웹뷰)
    구성: 2개의 모바일 화면이 나란히 배치됨. 왼쪽은 메인 화면에서 공지사항 섹션이 펼쳐진 상태로 공지 제목과 날짜가 표시됨. 오른쪽은 more를 클릭한 전체 공지사항 목록으로 날짜별 공지 제목이 나열됨
    Keyword: 공지사항, 모바일 웹뷰, 공지 목록, 날짜, 상세 보기
-->
