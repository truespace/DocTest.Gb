...
keyword: Console, Analytics, Oper
---
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Gamebase 앱 설정 콘솔 유저 레벨(INT)별 화면 #02
    구성: Gamebase 앱 설정 콘솔의 유저 레벨(INT)별 기능 설정/조회 화면 스크린샷
    Keyword: 앱 설정, Console, Screenshot, 유저 레벨(INT)별
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Gamebase 앱 설정 콘솔 월드/서버/채널별, 클래스/직업별 조회 화면 #03
    구성: Gamebase 앱 설정 콘솔의 월드/서버/채널별, 클래스/직업별 조회 기능 설정/조회 화면 스크린샷
    Keyword: 앱 설정, Console, Screenshot, 월드/서버/채널별, 클래스/직업별 조회
-->
...
<!-- LLM_Image_DESC_20260408_185735
    유형: Screenshot
    내용: Gamebase 앱 설정 콘솔 월드/서버/채널별, 클래스/직업별 등록 화면 #04
    구성: Gamebase 앱 설정 콘솔의 월드/서버/채널별, 클래스/직업별 등록 기능 설정/조회 화면 스크린샷
    Keyword: 앱 설정, Console, Screenshot, 월드/서버/채널별, 클래스/직업별 등록
-->
