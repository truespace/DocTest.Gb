...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: 아마존 개발자 콘솔
    구성: '아마존 개발자 콘솔' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: Amazon, App, Console, Store
-->
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: 앱 플랫폼 선택
    구성: '앱 플랫폼 선택' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: App, Console, IAP, Setting, Store
-->
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: 앱스토어 개발자 콘솔의 앱 목록
    구성: '앱스토어 개발자 콘솔의 앱 목록' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: App, Console, IAP, Setting, Store
-->
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: NHN Cloud Gamebase 스토어 설정 화면
    구성: 'NHN Cloud Gamebase 스토어 설정 화면' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: App, Console, IAP, Setting, Store
-->
### Store App ID
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: 아마존 개발자 콘솔의 앱 상세 설정 화면
    구성: '아마존 개발자 콘솔의 앱 상세 설정 화면' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: Amazon, App, Console, Setting, Store
-->
...
<!-- LLM_Image_DESC_20260407
    유형: Screenshot
    내용: 아마존 개발자 콘솔의 Identity 화면
    구성: '아마존 개발자 콘솔의 Identity 화면' 이미지. 콘솔/앱 화면 캡처 이미지
    Keyword: Amazon, Console, Setting
-->
